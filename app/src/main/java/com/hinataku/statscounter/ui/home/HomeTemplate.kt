...
private fun HomeTemplatePreview() {
  MaterialTheme {
    HomeTemplate(
      uiState = HomeUiState(
        games = listOf(Game(id = 1, name = "vs チームA")),
        playerSummaries = listOf(
          PlayerSummary(
            player = Player(id = 1, name = "おさむ"),
            gamesPlayed = 3, totalPoints = 24, total2P = 6, total3P = 4,
            totalAssists = 5, totalRebounds = 8, totalBlocks = 1, totalSteals = 3, totalTurnovers = 2,
          )
        ),
        rankings = listOf(
          RankingCategory(
            title = "得点",
            entries = listOf(
              RankingEntry(rank = 1, playerName = "おさむ", value = 24.0),
              RankingEntry(rank = 2, playerName = "みやた", value = 20.0),
              RankingEntry(rank = 3, playerName = "おおてき", value = 16.0),
            ),
          )
        ),
      ),
